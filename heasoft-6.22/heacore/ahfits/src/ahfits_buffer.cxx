...
// byte size for buffer to store element size of variable length columns
const int VARCOL_ELEM_SIZE=8;    

// -----------------------------------------------------------------------------

/// \brief Get size of an item for a given data type
...
/* Revision Log
 * $Log$
 * Revision 1.41  2017/05/02 21:38:21  rshill
 * Changed a doxygen-formatted comment to a normal comment.
 *
 * Revision 1.40  2017/04/25 23:20:33  rshill
 * Added calling seq comments.
 *
