...
/// \brief standard constructor for Connection
...
/// \brief test if connection is read-only
...
/// \brief test if connection is write-only
...
/// \brief test if connection is read-write
