...
void addHDU(FilePtr & ahffp_src, const std::string & extsrc, 
  ...
  ahfits::writeKeyValStr(ahffp_dest,"EXTNAME",extdest,"");   // keep keyword comment from src file
  ahfits::writeKeyValLLong(ahffp_dest,"naxis2",0LL,"");      // keep keyword comment from src file
...
void addEmptyTbl(FilePtr & ahffp, const std::string & extname) {
  ...
  ahfits::writeKeyValLLong(ahffp,"NAXIS2",0LL,"");   // keep keyword comment from fits_create_tbl
...
/* Revision Log
   $Log$
   Revision 1.63  2017/02/13 18:49:06  mwitthoe
