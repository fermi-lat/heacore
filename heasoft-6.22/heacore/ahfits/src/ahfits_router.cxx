...
/// \brief For testing/debugging: get index number of router
/// \return    router index
int Router::index() {
  return m_ridx;
}
...
/// \brief return the buffering overlap size
/// \return overlap size
...
/// \brief Get first iterator position in connection array
/// \return     STL 'begin' for connection array
Router::ConnectionIteratorType Router::connectionBegin() { return m_connection.begin(); }

// -----------------------------------------------------------------------------

/// \brief Get last iterator position plus one in connection array
/// \return     STL 'end' for connection array
Router::ConnectionIteratorType Router::connectionEnd(){ return m_connection.end(); }

// -----------------------------------------------------------------------------

/// \brief get number of connections to router
