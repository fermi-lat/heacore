...
/// \brief test whether FITS binary table is positioned at last row
/// \param[in] ahffp The FITS file object
/// \return    true if current row is last row; otherwise false
...
/// \brief Test whether there is more to read in the FITS extension
/// \param[in] ahffp The FITS file object.
/// \return true if there is at least one unread row in the
