...
/** \brief function providing behavior of AH_OUT macro
 *  \param[in]  func       function name, result of __func__
...
/** \brief function providing behavior of AH_INFO macro
 *  \param[in] chatter     ahlog::LOW or ahlog::HIGH
 *  \param[in]  func       function name, result of __func__
 *  \return stream for log message
 */
...
/** \brief function providing behavior of AH_WARN macro
 *  \param[in] chatter     ahlog::LOW or ahlog::HIGH
 *  \param[in]  func       function name, result of __func__
 *  \return stream for log message
 */
...
/** \brief function providing behavior of AH_ERR macro
 *  \param[in]  func       function name, result of __func__
 *  \return stream for log message
 */
...
/** \brief function providing behavior of AH_DEBUG macro
 *  \param[in] pfunc       function name, result of __PRETTY_FUNCTION__
 *  \return stream for log message
 */
...
/** \brief print stacktrace if in DEBUG mode
...
/** \brief Set the chatter level: 1 (low) - 3 (high)
    \param[in] val chatter level 1, 2, or 3
